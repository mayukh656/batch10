try{
    node{
     ...
     emailext body: 'Your build has been unsuccessful', subject: '$PROJECT_NAME - Build # $BUILD_NUMBER - $BUILD_STATUS!', to: 'jetscmlearning@gmail.com'
}
finally {
     (currentBuild.result!= "ABORTED") && node("master") {
      echo "finally gets executed and end an email notification for every build"
      emailext body: 'Your build has been successful', subject: '$PROJECT_NAME - Build # $BUILD_NUMBER - $BUILD_STATUS!', to: 'jet.scmlearning@gmail.com'
          }
}
